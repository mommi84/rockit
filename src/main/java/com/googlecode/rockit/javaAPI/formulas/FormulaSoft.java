...
public class FormulaSoft extends FormulaHard {
	...
	public FormulaSoft(String name, HashSet<VariableType> forVariables, ArrayList<IfExpression> ifExpressions,
			VariableDouble doubleVariable, ArrayList<PredicateExpression> restrictions, boolean usesConjunction) throws ParseException {
	...
	public String toString(){
		...
		if(weight!=null) sb.append(this.getWeight());
		if(doubleVariable!=null) sb.append(this.doubleVariable.toString()).append(":");
		sb.append("  ");
		
		sb.append(super.toSuperString());
		
		if(this.isConjunction()) sb.append("(");
		int i=0;
