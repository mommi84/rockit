...
public class ExhausiveBenchmarkTests {
	...
	public static void main(String[] args) throws ReadOrWriteToFileException, ParseException, IOException, RecognitionException, SolveException, SQLException {
		...
		double[] gapArray = new double[]{0.1, 0.05, 0.01, 0.001, 0.0005, 0.0001, 0.00005, 0.00001, 0.000005, 0.000001, 
				0.00000000001};
		...
		for(int i = 0; i<gapArray.length; i++){
			...
			long runtime = 0;
			results.add("gap:"+gapArray[i]);writer.writeln("gap:"+gapArray[i]);;
			results.add("flip:"+flipArray[i]);writer.writeln("flip:"+flipArray[i]);
