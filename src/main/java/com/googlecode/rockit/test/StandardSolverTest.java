...
public class StandardSolverTest {
	...
	public static String test(String modelFile, String evidenceFile,
			double gap, boolean useCPI, boolean useZVarAgg)
			throws ParseException, IOException, RecognitionException,
		...
		// evaluation
		System.out.println("=ROCKIT EVAL=CPI "
				+ Parameters.USE_CUTTING_PLANE_INFERENCE + "=Z-VAR AGGR "
				+ Parameters.USE_CUTTING_PLANE_AGGREGATION
				+ "============================================");
